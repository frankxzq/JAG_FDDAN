...
class ResClassifier(nn.Module):
    def __init__(self, num_classes=7,  num_unit=128, middle=64):   # num_unit=128, middle=64
...
class ResClassifier2(nn.Module):
    def __init__(self, num_classes=7,  num_unit=64, middle=32):   # num_unit=128, middle=64
